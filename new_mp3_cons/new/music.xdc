...
# connect_debug_port u_ila_0/probe1 [get_nets [list ACL_MISO_IBUF]]
# create_debug_port u_ila_0 probe
# set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
# set_property port_width 1 [get_debug_ports u_ila_0/probe2]
# connect_debug_port u_ila_0/probe2 [get_nets [list ACL_MOSI_OBUF]]
# create_debug_port u_ila_0 probe
# set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
# set_property port_width 1 [get_debug_ports u_ila_0/probe3]
# connect_debug_port u_ila_0/probe3 [get_nets [list ACL_SCLK_OBUF]]
# set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
# set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
# set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
# # connect_debug_port dbg_hub/clk [get_nets clk_IBUF_BUFG]

# set_property MARK_DEBUG true [get_nets display_vga/play_pause]
# set_property MARK_DEBUG true [get_nets {display_vga/play_pause_square3[1]}]
# set_property MARK_DEBUG true [get_nets {display_vga/play_pause_square3[2]}]
# set_property MARK_DEBUG true [get_nets {display_vga/play_pause_square3[3]}]
# set_property MARK_DEBUG true [get_nets {display_vga/play_pause_square3[4]}]
# set_property MARK_DEBUG true [get_nets {display_vga/play_pause_square3[5]}]
# set_property MARK_DEBUG true [get_nets {display_vga/play_pause_square3[6]}]
# set_property MARK_DEBUG true [get_nets {display_vga/play_pause_square3[7]}]
# set_property MARK_DEBUG true [get_nets {display_vga/play_pause_square3[8]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[9]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[5]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[6]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[10]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[11]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[12]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[0]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[12]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[7]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[11]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[1]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[4]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[8]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[9]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[14]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[10]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[15]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[0]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[2]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[3]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[4]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[5]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[8]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[14]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[15]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[3]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[7]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sx[13]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[1]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[2]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[6]}]
# set_property MARK_DEBUG true [get_nets {display_vga/sy[13]}]
# set_property MARK_DEBUG false [get_nets display_vga/i_pause_reg_reg_P]
# set_property MARK_DEBUG true [get_nets mp3_show_vga/i_pause_reg__0]
# set_property MARK_DEBUG true [get_nets display_vga/display_timing_600p/mp3_show_vga/play_pause_square2]
# create_debug_core u_ila_0 ila
# set_property ALL_PROBE_SAME_MU true [get_debug_cores u_ila_0]
# set_property ALL_PROBE_SAME_MU_CNT 1 [get_debug_cores u_ila_0]
# set_property C_ADV_TRIGGER false [get_debug_cores u_ila_0]
...
# set_property C_TRIGOUT_EN false [get_debug_cores u_ila_0]
# set_property port_width 1 [get_debug_ports u_ila_0/clk]
# connect_debug_port u_ila_0/clk [get_nets [list display_vga/display_clocks_inst/o_clk_1x]]
# set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe0]
# set_property port_width 16 [get_debug_ports u_ila_0/probe0]
# connect_debug_port u_ila_0/probe0 [get_nets [list {display_vga/sx[0]} {display_vga/sx[1]} {display_vga/sx[2]} {display_vga/sx[3]} {display_vga/sx[4]} {display_vga/sx[5]} {display_vga/sx[6]} {display_vga/sx[7]} {display_vga/sx[8]} {display_vga/sx[9]} {display_vga/sx[10]} {display_vga/sx[11]} {display_vga/sx[12]} {display_vga/sx[13]} {display_vga/sx[14]} {display_vga/sx[15]}]]
# create_debug_port u_ila_0 probe
# set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
# set_property port_width 8 [get_debug_ports u_ila_0/probe1]
# connect_debug_port u_ila_0/probe1 [get_nets [list {display_vga/play_pause_square3[1]} {display_vga/play_pause_square3[2]} {display_vga/play_pause_square3[3]} {display_vga/play_pause_square3[4]} {display_vga/play_pause_square3[5]} {display_vga/play_pause_square3[6]} {display_vga/play_pause_square3[7]} {display_vga/play_pause_square3[8]}]]
# create_debug_port u_ila_0 probe
# set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
# set_property port_width 16 [get_debug_ports u_ila_0/probe2]
# connect_debug_port u_ila_0/probe2 [get_nets [list {display_vga/sy[0]} {display_vga/sy[1]} {display_vga/sy[2]} {display_vga/sy[3]} {display_vga/sy[4]} {display_vga/sy[5]} {display_vga/sy[6]} {display_vga/sy[7]} {display_vga/sy[8]} {display_vga/sy[9]} {display_vga/sy[10]} {display_vga/sy[11]} {display_vga/sy[12]} {display_vga/sy[13]} {display_vga/sy[14]} {display_vga/sy[15]}]]
# create_debug_port u_ila_0 probe
# set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
# set_property port_width 1 [get_debug_ports u_ila_0/probe3]
# connect_debug_port u_ila_0/probe3 [get_nets [list display_vga/display_timing_600p/mp3_show_vga/play_pause_square2]]
...
# connect_debug_port u_ila_1/probe0 [get_nets [list mp3_show_vga/i_pause_reg__0]]
# create_debug_port u_ila_1 probe
# set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_1/probe1]
# set_property port_width 1 [get_debug_ports u_ila_1/probe1]
# connect_debug_port u_ila_1/probe1 [get_nets [list display_vga/play_pause]]
# set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
# set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
# set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
# connect_debug_port dbg_hub/clk [get_nets clk_IBUF_BUFG]
